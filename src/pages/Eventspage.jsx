  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'arial' }}>
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: '3rem', fontWeight: 'bold', color: '#1E3A8A', marginBottom: '0.5rem' }}>
          Events
        </h1>
        ...
        {events.map((event) => (
          <div key={event.id} style={{
            ...
            <div style={{ padding: '15px', flexGrow: 1 }}>
              {/* Display title if it exists, otherwise fall back to name */}
              ...
              <h4 style={{ fontSize: '1rem', color: '#666' }}>
      ...
      {isModalOpen && modalContent && (
        <div style={{
          ...
          <div style={{
            ...
            {/* Use title in modal if it exists, otherwise fall back to name */}
